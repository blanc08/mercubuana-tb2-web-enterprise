...
<footer className="relative bg-raisin-black text-white pt-8 pb-6">
    ...
    <div className="flex flex-wrap text-left lg:text-left">
      <div className="w-full lg:w-6/12 px-4">
        ...
        <ul>
            ...
            <li>
                Muhammad Faisal syahroni
            </li>
            <li>
                Rully Hidayatullah Faizal
            </li>
        </ul>
      ...
      <div className="w-full lg:w-6/12 px-4">
        <div className="flex flex-wrap items-top mb-6">
          <div className="w-full lg:w-4/12 mt-2  md:px-4 md:mt-0 ml-auto ">
          ...
          <div className="w-full lg:w-4/12 mt-2  md:px-4 md:mt-0">
    ...
    <div className="flex flex-wrap items-center md:justify-between justify-center">
      <div className="w-full md:w-4/12 px-4 mx-auto text-center">
        <div className="text-sm text-blueGray-500 font-semibold py-1">
          Copyright © <span id="get-current-year">2023</span><a href="https://www.creative-tim.com/product/notus-js" className="text-blueGray-500 hover:text-gray-800" target="_blank"/> PlaneTicketBooking
