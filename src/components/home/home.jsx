...
const Tiket = () => {
  ...
  return (
    <>
      <div className=''>
      <div className=" mx-10 mt-8 p-4 bg-ghost-white rounded shadow-md">
        <h1 className="text-2xl font-bold mb-4 text-center text-primary">Pemesanan Tiket Pesawat</h1>
        ...
        <form className="my-8 mx-10">
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
            ...
            <div className="flex-grow">
              <label htmlFor="departure" className="block text-sm font-medium text-gray-600">Keberangkatan</label>
              <input type="date" id="departure" name="departure" className=" p-2 w-full border rounded-md"/>
            </div>

            <div className="flex-grow">
              <label htmlFor="return" className="block text-sm font-medium text-gray-600">Pulang</label>
              <div className="flex items-center">
                <input type="checkbox" id="returnCheckbox" onChange={(e) => setReturnDateEnabled(e.target.checked)} className="mr-2"/>
                <input type="date" id="return" name="return" disabled={!returnDateEnabled} className=" p-2 w-full border rounded-md"/>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 mt-4">
            <div className="flex-grow">
              <label htmlFor="passengers" className="block text-sm font-medium text-gray-600">Jumlah Penumpang</label>
              <select id="passengers" name="passengers" className="mt-1 p-2 w-full border rounded-md">
            ...
            <div className="flex-grow">
              <label htmlFor="className" className="block text-sm font-medium text-gray-600">Kelas</label>
              <select id="className" name="className" className="mt-1 p-2 w-full border rounded-md">
